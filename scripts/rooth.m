...
coeffVector = input('Escreva os coeficientes no seguinte formato: \n i.e. [an an-1 an-2 ... a0] = ');
...
if unstablePoles == 0
    ...
    fprintf('~~~~~> Não é um Sistema Estável! <~~~~~\n')
end

fprintf('\n Number of right hand side poles =%2.0f\n',unstablePoles)

reply = input('Você quer que mostre as raizes? S/N ', 's');
if reply == 's' || reply == 'S'
    sysRoots = roots(coeffVector);
    fprintf('\n Dados os coeficientes polinomiais das raízes:\n');
    sysRoots;
end